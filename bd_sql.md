## Запросы:
### Сафаров
1.Нужно собрать статистику по супергероям из двух вселенных — Marvel и DC.

Для каждой вселенной отдельно вывести:
  + общее количество супергероев;
  + среднее количество появлений (appearances) на одного героя;
  + общее (суммарное) количество появлений всех героев;
  + минимальное и максимальное количество появлений среди героев этой вселенной;
  + самый ранний и самый поздний год первого появления героя (year).

Дополнительно:
добавить подзапрос, который для каждой вселенной найдёт самого популярного супергероя (с максимальным appearances) и покажет его имя.

Результат отсортировать по убыванию общего количества героев во вселенной.
